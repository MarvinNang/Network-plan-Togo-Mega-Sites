...
var format_Solarsitesgoinglive_6 = new ol.format.GeoJSON();
var features_Solarsitesgoinglive_6 = format_Solarsitesgoinglive_6.readFeatures(json_Solarsitesgoinglive_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Solarsitesgoinglive_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Solarsitesgoinglive_6.addFeatures(features_Solarsitesgoinglive_6);
var lyr_Solarsitesgoinglive_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Solarsitesgoinglive_6, 
                style: style_Solarsitesgoinglive_6,
                popuplayertitle: 'Solar sites going live',
                interactive: true,
                title: '<img src="styles/legend/Solarsitesgoinglive_6.png" /> Solar sites going live'
            });
var group_Sitesforurgentactivation = new ol.layer.Group({
                                layers: [],
                                fold: 'open',
                                title: 'Sites for urgent activation'});
var group_Scenario1 = new ol.layer.Group({
                                layers: [],
                                fold: 'close',
                                title: 'Scenario 1'});
var group_Scenario2 = new ol.layer.Group({
                                ...
                                fold: 'close',
                                title: 'Scenario 2'});
var group_NetworkplanV2 = new ol.layer.Group({
                                layers: [],
                                fold: 'close',
                                title: 'Network plan V2'});
var group_Basedata = new ol.layer.Group({
                                layers: [],
                                fold: 'close',
                                title: 'Base data'});
var group_Randomdata = new ol.layer.Group({
                                layers: [],
                                fold: 'close',
                                title: 'Random data'});
...
lyr_GoogleSatelliteHybrid_0.setVisible(true);lyr_Regions_1.setVisible(true);lyr_Locationscores_2.setVisible(true);lyr_Activesites_3.setVisible(true);lyr_Identifiedsites_4.setVisible(true);lyr_PlannedSolarHubs_5.setVisible(true);lyr_Solarsitesgoinglive_6.setVisible(true);
var layersList = [lyr_GoogleSatelliteHybrid_0,lyr_Regions_1,lyr_Locationscores_2,lyr_Activesites_3,lyr_Identifiedsites_4,lyr_PlannedSolarHubs_5,lyr_Solarsitesgoinglive_6];
...
lyr_Solarsitesgoinglive_6.set('fieldAliases', {'S/N�': 'S/N�', 'STATION ID': 'STATION ID', 'City': 'City', 'prefecture': 'prefecture', 'STATION NA': 'STATION NA', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Vendor Nam': 'Vendor Nam', 'Civil Work': 'Civil Work', 'Office Sup': 'Office Sup', 'Start date': 'Start date', 'Status': 'Status', 'Condition': 'Condition', });
...
lyr_Solarsitesgoinglive_6.set('fieldImages', {'S/N�': 'TextEdit', 'STATION ID': 'TextEdit', 'City': 'TextEdit', 'prefecture': 'TextEdit', 'STATION NA': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'Vendor Nam': 'TextEdit', 'Civil Work': 'TextEdit', 'Office Sup': 'TextEdit', 'Start date': 'TextEdit', 'Status': 'TextEdit', 'Condition': 'TextEdit', });
...
lyr_PlannedSolarHubs_5.set('fieldLabels', {'S/N�': 'hidden field', 'STATION ID': 'hidden field', 'City': 'hidden field', 'prefecture': 'hidden field', 'STATION NA': 'hidden field', 'Latitude': 'inline label - always visible', 'Longitude': 'inline label - always visible', 'Vendor Nam': 'hidden field', 'Civil Work': 'hidden field', 'Office Sup': 'header label - always visible', 'Start date': 'hidden field', 'Status': 'hidden field', 'Condition': 'hidden field', 'id': 'hidden field', 'Site_Name': 'hidden field', 'Area': 'hidden field', 'Type': 'inline label - always visible', ' Nb_racks': 'inline label - always visible', 'layer': 'hidden field', 'path': 'hidden field', });
lyr_Solarsitesgoinglive_6.set('fieldLabels', {'S/N�': 'hidden field', 'STATION ID': 'hidden field', 'City': 'inline label - always visible', 'prefecture': 'hidden field', 'STATION NA': 'inline label - always visible', 'Latitude': 'inline label - always visible', 'Longitude': 'inline label - always visible', 'Vendor Nam': 'hidden field', 'Civil Work': 'hidden field', 'Office Sup': 'hidden field', 'Start date': 'hidden field', 'Status': 'hidden field', 'Condition': 'hidden field', });
lyr_Solarsitesgoinglive_6.on('precompose', function(evt) {
